...
| Seed | `42` |
| Exposure mode | `research_instructor` |
...
| lead_meta | 6 | lead_id, lead_created_at, lead_source |
...
**Leakage-flagged columns:** `current_stage`, `is_sql`, `total_touches_all`. See `feature_dictionary.csv` for details.
